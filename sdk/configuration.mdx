...
<Tabs>
  ...
  <Tab title="React Native">
    ...
    type CarouselOverlayConfig = 'none' | { type: 'custom'; component: React.ComponentType };
...
<Tabs>
  ...
  <Tab title="Web">
    ...
    const filter = {
      ...
      contentType: 'video',        // 'video' or 'carousel'
...
| `contentType` | `String?` | Filter by content type: `"video"` or `"carousel"`. |
