...
description: "A content item represents a video or image carousel in your feed. This page covers the object structure, upload and publish lifecycle, and how content reaches your users."
---
...
These fields are only present on carousel content items.
...
**Carousels** skip processing entirely — images are served directly, so carousels are `ready` immediately after creation.
