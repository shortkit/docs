...
Weights are configurable via the [Ranking API](/api-reference/endpoints/ranking).
...
<Columns cols={2}>
  <Card title="Feed ranking" icon="sort" href="/infrastructure/feed-ranking">
    Configure ranking algorithm.
  </Card>
  <Card title="Events API" icon="chart-line" href="/api-reference/endpoints/events">
