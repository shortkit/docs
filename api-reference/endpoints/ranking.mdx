...
<Columns cols={2}>
  <Card title="Feed configuration" icon="list" href="/admin-portal/feed-configuration">
    Configure ranking in Admin Portal.
  </Card>
  <Card title="A/B testing" icon="flask" href="/api-reference/endpoints/experiments">
