...
<Tip>
  See [Engagement Signals](/guides/engagement/engagement-signals) for the full event schema and delivery details.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Engagement Signals" icon="chart-line" href="/guides/engagement/engagement-signals">
  ...
  <Card title="SDK Installation" icon="download" href="/sdk/installation">
    Full SDK reference including installation, configuration, and setup.
  </Card>
</CardGroup>
