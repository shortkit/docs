...
See the [Data export guide](/guides/engagement/data-export) for full details.
...
<Columns cols={2}>
  <Card title="Feed configuration" icon="sliders" href="/guides/feed/feed-configuration">
    How identity affects content personalization.
  </Card>
  <Card title="Engagement events" icon="signal" href="/guides/engagement/engagement-signals">
